...
// Load data from Supabae
loadFacts();

async function loadFacts() {
  const res = await fetch(
    "https://hxawjvhjuscfkyevguka.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh4YXdqdmhqdXNjZmt5ZXZndWthIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk2NjU3MzMsImV4cCI6MjA5NTI0MTczM30.Ul0SETMaSWkep14K9IjH47gIQZ6xZG9wpnu1-nYUwEc",
      },
    },
  );
...
function createFactsList(dataArray) {
  // factsList.insertAdjacentHTML("afterbegin", "<li>Morteza</li>");
...
if (votesIntresting === votesMindblowing) {
  ...
  console.log("Mindblowing gact!!");
}

// falsy values: 0, '', null, undifined
